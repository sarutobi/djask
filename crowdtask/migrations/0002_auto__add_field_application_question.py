...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Application.question'
        db.add_column('crowdtask_application', 'question',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Application.question'
        db.delete_column('crowdtask_application', 'question')
