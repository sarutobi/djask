...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskRun.application'
        db.add_column('crowdtask_taskrun', 'application',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crowdtask.Application'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaskRun.application'
        db.delete_column('crowdtask_taskrun', 'application_id')
    ...
    models = {
        ...
        'crowdtask.taskrun': {
            ...
            'application': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['crowdtask.Application']", 'null': 'True'}),
            'creation_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'info': ('crowdtask.fields.JSONField', [], {}),
