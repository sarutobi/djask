...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TaskRun.application'
        db.alter_column('crowdtask_taskrun', 'application_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['crowdtask.Application']))

        # Changing field 'Application.presenter'
        db.alter_column('crowdtask_application', 'presenter', self.gf('crowdtask.fields.JSONField')())

    def backwards(self, orm):

        # Changing field 'TaskRun.application'
        db.alter_column('crowdtask_taskrun', 'application_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crowdtask.Application'], null=True))

        # Changing field 'Application.presenter'
        db.alter_column('crowdtask_application', 'presenter', self.gf('django.db.models.fields.URLField')(max_length=200))
    ...
    models = {
        ...
        'crowdtask.application': {
            ...
            'presenter': ('crowdtask.fields.JSONField', [], {'default': "''"}),
